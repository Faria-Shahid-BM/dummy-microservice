...
rules texts live in ``data/insurance/`` next to this module and can be
overridden per call.
"""
...
_DATA_DIR = _MODULE_DIR / "data" / "insurance"

_EXTRACTION_PROMPT_PATH = _MODULE_DIR / "insurance_extraction.md"
_ANALYSIS_PROMPT_PATH = _MODULE_DIR / "insurance_analysis.md"
    ...
    *,
    ...
    Args:
        ...
        policy_rules_text: Bank policy text; defaults to the bundled
            ``data/insurance/policy.txt``.
        collateral_rules_text: Collateral classification/compatibility rules;
            defaults to the bundled ``data/insurance/collateral_policy_rules.txt``.
